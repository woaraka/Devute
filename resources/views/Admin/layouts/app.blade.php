...
<html lang="en">
    <head>
        ...
        <!-- inject:css -->
        <link rel="stylesheet" href="{{ asset('theme/css/style.css') }}?v8">
        <!-- endinject -->
        ...
        <link rel="shortcut icon" href="{{ asset('theme/images/logo.png') }}?13" />
    </head>
    <body>
        @yield('modal')
        ...
        <!-- partial:partials/_navbar.html -->
            <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo mr-5" href="{{ URL('admin/home') }}"><img src="{{ asset('theme/images/logo1.svg') }}?13" class="mr-2" alt="logo"/></a>
                    <a class="navbar-brand brand-logo-mini" href="{{ URL('admin/home') }}"><img src="{{ asset('theme/images/logo.png') }}?13" alt="logo"/></a>
                </div>
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="{{ route('admin.login') }}">
                                    <i class="ti-user text-primary"></i>{{ Auth::User()->name }}
                                </a>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('PageAssignEmp') }}">
                                <i class="ti-menu menu-icon"></i>
                                <span class="menu-title">Assign Page</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                @yield('content')
                    ...
                    <footer class="footer">
                        <div class="d-sm-flex justify-content-center justify-content-sm-between">
                            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 <a href="http://www.Devute.co/" target="_blank">Devute</a>. All rights reserved.</span>
{{--                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="ti-heart text-danger ml-1"></i></span>--}}
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.17/css/bootstrap-select.min.css" crossorigin="anonymous">
